...
function custom_create_shortcode_teams_post_type(){
    ...
    if($query->have_posts()) :
        ...
        while($query->have_posts()) :             
			...
			$result .= '<div class="team-social"><a target="_blank"  href="'. get_field("linkedin_url").'"><img src="https://codelinear.com/tradejini/wp-content/uploads/2023/06/mdi_linkedin-white.svg"/></a>';
			$result .= '<a target="_blank"  href="'. get_field("twitter_link").'"><img src="https://codelinear.com/tradejini/wp-content/uploads/2023/06/twitter-fill-white.svg"/></a></div>';
			$result .= '</div>';
			$result .= '</div></div>';
...
function custom_create_shortcode_testimonial_post_type(){
    ...
    if($query->have_posts()) :
        ...
        while($query->have_posts()) :             
			...
			for ($i = 0; $i < $rating; $i++) {
				$output1 .= "<div class='star-list'><img src='https://codelinear.com/tradejini/wp-content/uploads/2023/06/start-icon.svg'></div>";
			} 			           
