...
<div id="site-logo" class="<?php echo esc_attr( oceanwp_header_logo_classes() ); ?>"<?php oceanwp_schema_markup( 'logo' ); ?> >
	...
	<div id="site-logo-inner" class="clr">
		...
		if ( function_exists( 'the_custom_logo' ) && has_custom_logo() ) {
			...
			<img src="./wp-content/uploads/2023/07/home-logo.svg" class="top-home-logo" alt="Tradejini">
			<img src="./wp-content/uploads/2023/06/logo-img.svg" class="bottom-home-logo" alt="Tradejini">
			<?php				
			} 
			else {				
				// Default logo.
