...
<ul class="meta ospm-<?php echo $sp_meta_sep_class; ?> clr">
	...
	foreach ( $sections as $section ) {
		...
		<?php if ( 'author' === $section ) { ?>
			<li class="meta-author"<?php oceanwp_schema_markup( 'author_name' ); ?>><span class="screen-reader-text"><?php esc_html_e( 'Post author:', 'oceanwp' ); ?></span><span class="gray-circle"></span><?php echo esc_html( the_author_posts_link() ); ?></li>
		<?php } ?>
